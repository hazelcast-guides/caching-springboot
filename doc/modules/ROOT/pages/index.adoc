...
If you want to use Hazelcast in the client-server topology, then it's enough to create `hazelcast-client.yaml` file instead of `hazelcast.yaml` on your classpath. And that's it! You configured a Hazelcast client.
